...
<ul class="block-grid-xs-2">
	<li>
		<h2>Can you build me a website?</h2>
		<p>Yes! If you're a small business with simple requirements I certainly can. If you're an agency, sorry - I don't design websites, only build them.</p>
	</li>
	<li>
		<h2>Why is that?</h2>
		<p>A few reasons, the red tape.</p>
	</li>
	<li>
		<h2>Who is your ideal client?</h2>
		<p>Agencies. I want to work with Agencies, followed by small business as a bonus.</p>
	</li>
</ul>
...
# BUILD A RESPONSIVE MEGA MENU WITH BOOTSTRAP AND JEKYLL
## BUILD A RESPONSIVE MEGA MENU WITH BOOTSTRAP AND JEKYLL
### BUILD A RESPONSIVE MEGA MENU WITH BOOTSTRAP AND JEKYLL
#### BUILD A RESPONSIVE MEGA MENU WITH BOOTSTRAP AND JEKYLL
##### BUILD A RESPONSIVE MEGA MENU WITH BOOTSTRAP AND JEKYLL
...
<h1>H1. You get a sense of it and you look away</h1>
